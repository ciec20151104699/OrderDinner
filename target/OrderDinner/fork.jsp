...
<head>
    ...
    <style>
        ...
        .cook_list .cook_mes_list{ width: 130px; margin-left: 10px; height: 100%; float: left; box-sizing: border-box; }
        .type_msg{ width: 100%; cursor: pointer;background: rgb(240, 243, 240); height: 40px; line-height: 40px; text-align: center;}
        .type_msg_first{background: sandybrown;   }
        .cook_list_msg{ width: 900px; margin-left: 50px;  float: left; height: 900px; overflow-x: hidden;overflow-y: auto;}
